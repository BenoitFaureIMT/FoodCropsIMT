...
class FoodCropFactory:
    # Constructeur de la classe FoodCropFactory qui s'occupe de créer les 3 dictionnaires
    def __init__(self):
        self.unitsRegistry = {}
        self.indicatorsRegistry = {}
        self.commodityRegistry = {}

    # les méthodes create suivantes permmette d'instancier des nouvelles unité/Commodity ou indicator
    # Pour cela on prend une des donnée et si elle n'est pas présente dans le dictionnaire on l'a crée
    # si elle est présente alors on retourne juste la valeur
